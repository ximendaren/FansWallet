<template>
    <div class="container-quotation">
      ...
      <div class="content">
        ...
        <p class="price" style="color:#1989fa" @click="discountCode_show=true">优惠码</p>  
        <p class="price">价格 <b style="color:red">{{total_price}} ETH</b></p>
        <van-button type="danger" size="large" class="pay_btn" @click="fast_pay">立即支付</van-button>
        ...
        <div class="discountCode-box">
            <van-field v-model="discount_code" placeholder="请输入优惠码" label="" label-width="10" maxlength="20" class="password-btn" /> 
        </div>
        ...
        show-cancel-button
        @confirm="confirm_pay"
        @cancel="formData.orderId=orderId;$router.push({name:'cancelPay',params:{cancelOrder:formData}})"
        >
    ...
    methods:{
        ...
        confirm_pay(){
            ...
            order_pay(params).then(r => {
                ...
                if(r.data.code === 0){
                    ...
                    this.$router.push({name:'successPay',params:{options:['基本功能']}})
        ...
        fast_pay(){
            ...
            let params = {
                ...
                // TokenOwnerAddress:this.formData.address_book,
                Remark:'',
                DiscountCode:'',
                TotalAmount:this.total_price,  //总价
                DiscountAmount:0,  //优惠
                ActualAmount:this.total_price,   //实收
                TokenType:"ETH",
	            Protocol:"ERC20",
                FuncIdList:[1]
